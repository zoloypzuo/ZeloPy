...
def generate_disassembly(co, lasti=-1):
	...
	while i < n:
		...
		if i in linestarts:
			...
			try:
				report.write(
					'<span class="line_no">%d</span><span class="tab">&nbsp;</span><span class="src">%s</span>' %
					(line_no, html_format(src_lines[line_no - 1].rstrip())))
			except:
				report.write(
					'<span class="line_no">%d</span><span class="tab">&nbsp;</span><span class="filename">(\'%s\')</span>' %
		...
		if op >= opcode.HAVE_ARGUMENT:
			...
			report.write(
				'<span class="address">%d</span><span class="tab">&nbsp;</span><span class="op">%02x&nbsp;%02x%02x</span><span class="tab">&nbsp;</span><span class="opname">%s</span><span class="tab">&nbsp;</span><span class="oparg">%d</span><span class="tab">&nbsp;</span><span class="decoration">%s</span>' %
				(i - 3, op, oparg_low, oparg_high, html_format(opname), oparg, decoration))
		else:
			report.write(
				'<span class="address">%d</span><span class="tab">&nbsp;</span><span class="op">%02x</span><span class="tab">&nbsp;</span><span class="opname">%s</span>' %
...
class MainWindow(QtGui.QMainWindow):
	...
	@QtCore.pyqtSlot()
	def open(self):
		file_list = map(str, QtGui.QFileDialog.getOpenFileNames(self,
